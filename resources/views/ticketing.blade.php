...
@section('content')
    <div class="bg-gray-100 flex-1 p-6 md:mt-16 grid grid-cols-8 h-screen">
        ...
        <div class="col-span-2 bg-white border rounded p-6 mr-8 h-full shadow-sm flex flex-col overflow-y-auto">
            ...
            <form action="{{ route('calendar.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="title" required
                        class="w-full p-2 border rounded text-sm focus:outline-none focus:border-indigo-500"
                ...
                <button type="submit"
                    class="w-full bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700 transition duration-200 text-sm font-bold flex justify-center items-center">
            ...
            <ul>
                <li class="my-5 mt-0">
                    <div class="text-indigo-600 font-bold flex items-center">
                        <i class="text-xs fad fa-info-circle mr-2"></i>
                        Status Sinkronisasi
                    </div>
            ...
            <div class="mt-auto pt-6 border-t">
                <a href="https://calendar.google.com" target="_blank"
                    class="text-xs text-gray-400 text-center block hover:text-indigo-500">
            ...
            <div class="flex-1 w-full h-full relative">
                ...
                <div class="absolute top-0 right-0 p-2">
                    <button onclick="document.querySelector('iframe').src = document.querySelector('iframe').src"
                        class="bg-white p-2 rounded shadow text-gray-600 hover:text-indigo-600 text-xs">
                        <i class="fad fa-sync"></i> Refresh Kalender
                    </button>
                </div>
            </div>
