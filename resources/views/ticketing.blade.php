...
@section('content')
<div class="bg-gray-100 flex-1 p-6 md:mt-16 grid grid-cols-1 md:grid-cols-4 gap-6 h-screen">

    {{-- BAGIAN SIDEBAR (Kiri - Form Input Jadwal) --}}
    <div class="col-span-1 bg-white border rounded p-6 h-full shadow-sm flex flex-col overflow-y-auto">
    ...
    <div class="col-span-1 md:col-span-3 card flex flex-col bg-white rounded shadow-sm h-full overflow-hidden relative border border-gray-200">

        {{-- Refresh Button Floating --}}
        <button onclick="document.querySelector('iframe').src = document.querySelector('iframe').src"
            class="absolute top-4 right-4 z-10 bg-white p-2 px-3 rounded-full shadow border border-gray-200 text-gray-600 hover:text-indigo-600 hover:border-indigo-200 text-xs font-semibold transition duration-200">
