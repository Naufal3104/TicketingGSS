            ...
            <div class="card-body h-full flex flex-col justify-between">
              ...
              <div class="flex flex-row mt-10 items-end">
                <div class="flex-1">
                  ...
                  <a href="#" class="btn-shadow py-3"> view sales </a>
                </div>
            ...
            <div class="w-1/3 lg:w-full">
              ...
              <div class="p-5">
                ...
                <div class="bg-gray-300 h-2 rounded-full mt-2 relative">
                  <div
                    class="rounded-full bg-teal-400 h-full w-3/4 shadow-md"
                  ></div>
                </div>
              </div>
              <!-- end bottom -->
            ...
            <div class="card-body">
              ...
              <h1 class="capitalize text-lg mt-1 mb-1">
                ...
                <span class="text-xs tracking-widest font-extrabold">
                  / <span class="num-2"></span> orders</span
                >
              </h1>
              <p class="capitalize text-xs text-gray-500">
                ( $<span class="num-2"></span> in the last year )
              </p>
            </div>
          </div>
          <!-- status -->
            ...
            <div class="card-body">
              ...
              <table class="table-auto w-full mt-5 text-right">
                ...
                <tbody>
                  ...
                  <tr class="">
                    <td
                      class="py-4 text-sm text-gray-600 flex flex-row items-center"
                    >
                      <div class="w-8 h-8 overflow-hidden mr-3">
